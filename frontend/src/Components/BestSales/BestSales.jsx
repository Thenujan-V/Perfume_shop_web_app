...
const BestSales = () => {
    ...
    useEffect(() =>{
        ...
        const fetchBestSalesData = async () => {
            try {
              const himResponse = await axios.get("http://localhost:8080/api/v1/products/bestselles"); 
              const herResponse = await axios.get("http://localhost:8080/api/v1/products/bestselles"); 
                    ...
                    <div className='BestSale'>
                        ...
                        {HimbestSales
                            .map((HimbestSale, index) => (
                                ...
                                <Card  >
                                <Link to={`/product/${HimbestSale.id}`}><Card.Img className='cardImg img-fluid ' variant="top" src={HimbestSale.imageURL} /></Link>
                ...
                <div className="herBestSales">
                    <div  className='BestSale'>
                        ...
                        {HerbestSales
                            ...
                            <div key={index} className="col-lg-4 col-md-6 col-12 d-flex justify-content-center align-items-center BestSaleImg">
                                  <Card className='card' >
                                  <Link to={`/product/${HerbestSale.id}`}><Card.Img className='cardImg img-fluid ' variant="top" src={HerbestSale.imageURL} /></Link>
                                    {/* <Card.Link href="#"> <img src={CartdIcon} alt=""  style={{ width: '50px', height: '50px' }}/></Card.Link> */}
                                    <Card.Body className='cardBody'>
